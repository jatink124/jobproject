 ...
 <?php  if(file_exists($filename))
{
  ...
  <div class="card-body">
   ...
   <span><h6>Last Date to apply:</h6><p><b><?php echo $ldtapply[$j]; ?></b></p></span>
    <a id=<?php echo $id[$j]?> href="isrojobsdetail" target="_blank" class="btn btn-primary idex">View Details</a>
...
<!-- row -->
 ...
 <?php } else {?>
      <?php   // A session is required
        ...
        // Add a few messages
        $msg->warning('No jobs notification related to ISRO present but please select from other jobs ');
